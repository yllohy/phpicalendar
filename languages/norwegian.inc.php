...
$upload_error_lang[3]	= 'Filen du pr&oslash;er Œ lasste opp ble bare delvis lastet.';
...
$format_recur_lang['bymonthday']	= 'PŒ datoene: %list%';			// ie, 'On dates: 1, 2, 3, 4'
$format_recur_lang['byday']			= 'PŒ dagene: %list%';			// ie, 'On days: Mon, Tues, Wed, Thurs'
